...
{
    public abstract class UserManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UserManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UserManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UserManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UserManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UserManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UserManagementDbContext, Task<T>> func)
        {
            T result;
